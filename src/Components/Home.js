  ...
  return (
    <div id="background">
      <div className="cont-1">
        ...
        <p id="welcome">
          Welcome to our webpage, where you can shop for cars to fulfill your
          transportation needs. We are thrilled to have you here and are
          committed to providing you an exeptional shopping experience. Where
          you're looking for a stylish sedan, a practical SUV, or a powerful
          sports car, we have a wide range of options to suit your preferences
          and budget. Our team of experts is dedicated to helping you find the
          perfect car that meets your requirements and exceeds your
          expectations. So, sit back, relax, and enjoy browsing our selection of
          cars.
        </p>
        <ul>
          <li>
      ...
      <div>
        <p className="thankyou">
          Thank you for taking the time to visit our website. We appreciate your
          interest in our selection of cars and hope that our platform provides
          you with a seamless shopping experience. If you have any questions or
          feedback, please don't hesitate to reach out to our friendly and
          knowledgeable team. We look forward to helping you find your perfect
          car!
        </p>
      </div>
    </div>
